...
const educationalFacts = {
    restaurant: [
        "هل تعلم أن الفلافل غنية بالألياف والبروتين النباتي وفيتامين B والحديد؟",
        "يساعد الحمص في تنظيم مستويات السكر في الدم وخفض الكوليسترول",
        "يحتوي خبز التنوري على سعرات حرارية أقل من الخبز العادي",
        "الفاهيتا هي وصفة مكسيكية تم تطويرها في المطبخ الشامي بشكل مميز",
        "زيت الزيتون المستخدم في طبخ الفلافل غني بمضادات الأكسدة",
        "الأعشاب المستخدمة في الفلافل مثل الكزبرة والبقدونس تساعد في الهضم",
        "تقنية القلي المستخدمة في مطعمنا تحافظ على القيمة الغذائية للطعام"
    ],
    saudi: [
        "تم توحيد المملكة العربية السعودية في عام 1932 على يد الملك عبدالعزيز",
        "تحتوي المملكة على أكبر احتياطي نفطي في العالم",
        "مدينة الرياض كانت تسمى قديماً 'حجر اليمامة'",
        "يبلغ ارتفاع جبل السودة 3000 متر عن سطح البحر",
        "تضم المملكة أكبر صحراء رملية متصلة في العالم - الربع الخالي",
        "تعتبر مكة المكرمة والمدينة المنورة من أقدم المدن في التاريخ"
    ],
    general: [
        "يحتوي المحيط الهادئ على أعمق نقطة في العالم - أخدود ماريانا",
        "تشكل قارة آسيا 30% من مساحة اليابسة على الأرض",
        "اليابان هي موطن لأقدم شركة في العالم عمرها أكثر من 1400 سنة",
        "تم اكتشاف أن بلوتو ليس كوكباً في عام 2006",
        "يمكن رؤية سور الصين العظيم من الفضاء الخارجي"
    ],
    religious: [
        "استغرق نزول القرآن الكريم 23 عاماً كاملة",
        "يوجد في القرآن الكريم 114 سورة و6236 آية",
        "مسجد قباء هو أول مسجد بُني في الإسلام وما زال قائماً حتى اليوم",
        "صلاة الظهر هي أول صلاة فُرضت في الإسلام",
        "الكعبة المشرفة تم بناؤها على يد سيدنا إبراهيم وابنه إسماعيل عليهما السلام",
        "المسجد النبوي كان في البداية مساحته 70 × 60 متراً فقط"
    ]
};
